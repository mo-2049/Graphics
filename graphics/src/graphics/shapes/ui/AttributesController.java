...
public class AttributesController {
	...
	class AttributesListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(aView.getSelectedColor()=="red")	model.addAttributes(new ColorAttributes (true, true, Color.RED, Color.RED));
			if(aView.getSelectedColor()=="green")	model.addAttributes(new ColorAttributes (true, true, Color.GREEN, Color.GREEN));
			if(aView.getSelectedColor()=="blue")	model.addAttributes(new ColorAttributes (true, true, Color.BLUE, Color.BLUE));
